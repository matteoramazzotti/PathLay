...
function logic_list_handler(type) {
    ...
    if (type === "meth") {
        //console.log("displaying selector meth select");
        active_logical_selected_element.type = "meth";
        document.getElementById("methIDSelect").style.display = 'block';
    }
    if (type === "chroma") {
        //console.log("displaying selector chroma select");
        active_logical_selected_element.type = "chroma";
        document.getElementById("chromaIDSelect").style.display = 'block';
    }
    if (type === "tf") {
        //console.log("displaying selector tf select");
        active_logical_selected_element.type = "tf";
        document.getElementById("tfIDSelect").style.display = 'block';
    }
