...
// 	mus_musculus : "mmu"
// };
// var interactionDBPath = "";
// var forkedProcesses = [];

// const requestQueueMaps = new RequestQueue();
// const requestQueueDBs = new RequestQueue();

// function updateResultsContainer(status,organism) {
...
// check integrity
function checkFileExistence(organism) {
	console.log("checkFileExistence: "+organism)

	var selectedSpecies = this.value ? this.value : organism;
	interactionDBPath = `pathlay_data/${organismCodes[selectedSpecies]}/db/`;
