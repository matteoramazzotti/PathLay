...
sub AddMethylsCirc2{
    ...
    if ($up > 0 && $dn > 0) {
        #@x = (35,50,65,50); #sx and up x coords
        #@y = (20,5,20,35); #sx and up y coords

        #@x2 = (70,85,100,85);
        #@y2 = (20,5,20,35);

        my $square = new GD::Polygon;
        $square -> addPt(20,20); #sx
        $square -> addPt(35,5); #up
        $square -> addPt(50,20); #dx
        $square -> addPt(35,35); #dn
        $graph -> filledPolygon($square,$grey);
        $graph -> openPolygon($square,$black);

        $square = new GD::Polygon;
        $square -> addPt(51,20); #sx
        $square -> addPt(66,5); #up
        $square -> addPt(81,20); #dx
        $square -> addPt(66,35); #dn
        $graph -> filledPolygon($square,$grey);
        $graph -> openPolygon($square,$black);
        ...
        $square = new GD::Polygon;
        $square -> addPt(25,20); #sx
        $square -> addPt(35,10); #up
        $square -> addPt(45,20); #dx
        $square -> addPt(35,30); #dn
        $graph -> filledPolygon($square,$c[0]);
        $graph -> openPolygon($square,$black);

        $square = new GD::Polygon;
        $square -> addPt(56,20); #sx
        $square -> addPt(66,10); #up
        $square -> addPt(76,20); #dx
        $square -> addPt(66,30); #dn
...
sub AddmiRNAsCirc_demo{
    ...
    if ($urnas == 1) {
        $graph->filledEllipse(20,50,20,20,$color);
        $graph->arc(20,50,20,20,0,360,$graph->colorAllocate(0,0,0));
    }
...
sub AddmiRNAsSquare{
    ...
    if ($urnas == 1) {
        ...
        $graph->arc(30,25,20,20,0,360,$black);
    }
...
sub AddmiRNAsSquare_demo{
    ...
    if ($urnas == 1) {
        $graph->filledEllipse(30,25,20,20,$color);
        $graph->arc(30,25,20,20,0,360,$graph->colorAllocate(0,0,0));
    }
