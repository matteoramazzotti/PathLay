function spawnReportDiv() {
    ...
    let accessReportContinueButton = spawnInput ("accessReportContinueButton","accessReportContinueButton","button","Continue","");
    ...
    if (currentConf.checks.submitEnabled === true) {
        ...
        for (let dataType in currentConf.previews) {
            ...
            let dataTitle = spawnFont(``,`warningFont`,`- ${dataType} Preview:`);
...
var currentConf = {
    ...
    resetConf: function () {
        ...
        let dataTypes = ["gene","prot","urna","meth","meta"];
